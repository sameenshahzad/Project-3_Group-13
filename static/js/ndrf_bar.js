            ...
            searchBtn.addEventListener("click", (event) => {
                ...
                if (selectedCountry) {
                    ...
                    function get_year() {
                        ...
                        var dropdown_menu = d3.select('#selDataset_ndrf_bar');
                      ...
                      // Calculate the average of all pollution types
                        ...
                        const deviations = [
                            ...
                            selectedCountry[year].LBMD - avgPollution,
                            ...
                            selectedCountry[year].NAHF - avgPollution,
                            selectedCountry[year].LNS - avgPollution,
                            selectedCountry[year].LNS - avgPollution,
                            selectedCountry[year].SS - avgPollution,
                            selectedCountry[year].US - avgPollution,
                            selectedCountry[year].UWS - avgPollution,
                            selectedCountry[year].DB - avgPollution,
                            selectedCountry[year].LWGD - avgPollution,
                            selectedCountry[year].AU - avgPollution,
                            selectedCountry[year].LBW - avgPollution,
                            selectedCountry[year].UNS - avgPollution
                        ];
                        ...
                        const barData = [
                            {
                                ...
                                "Low Bone Mineral Density", "High Systolic Blood Pressure", "Iron Deficiency", "Low Physical Activity", "non Exclusive Breastfeeding",
                                "Particulate Matter Pollution", "Smoking", "No Access to Handwashing Facility", "Low in Nuts and Seed", "Secondhand Smoke", "Unsafe Sanitation", "Unsafe Water Source", "Discontinued Breastfeeding",
                                "Low Whole Grains Diet", "Alcohol Use", "Low Birth Weigh", "Unsafe Sex",
                            ],
                                type: "bar",
                                marker: {
                        ...
                        Plotly.newPlot("ndrf_bar_chart", barData, barLayout);
                      }
                      ...
                      d3.select('#selDataset_ndrf_bar').on('change', function() {
